...
var pages = []pageSpec{
	{
		...
		Output:      "index.html",
		NavLabel:    "Home",
		Title:       "Hino & Hilux Specialists Serving Gauteng Fleets",
		Description: "A family-run workshop serving Gauteng fleets, with 50+ years of combined experience servicing Hino trucks and Hilux bakkies for fleets of 5 to 100 vehicles.",
	...
	},
	{
		...
		NavLabel:    "Services",
		Title:       "Services: Hino & Hilux servicing for Gauteng fleets",
		Description: "Diagnostics, preventative maintenance, engine overhauls and mechanical repairs for Hino 300, 500 and 700 trucks and the Hilux D4D 2.5, D4D 3.0, GD6 2.4 and GD6 2.8. Gauteng fleets only.",
	...
	},
	{
		...
		NavLabel:    "About us",
		Title:       "About us: a family Hino & Hilux workshop for Gauteng fleets",
		Description: "A father-and-two-sons workshop serving Gauteng fleets, with 50+ years of combined experience specialising in Hino trucks and the Toyota Hilux.",
